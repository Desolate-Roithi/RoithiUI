local MINOR = 14
print("|cffffff00[LibEditMode-Roithi]|r Loading v" .. MINOR)
local lib = LibStub:NewLibrary("LibEditMode-Roithi", MINOR)
if not lib then
...
function lib:AddFrame(frame, callback, default, name)
	...
	if not internal.dialog then
		...
		-- Initialize Extension for extra settings
		if internal.CreateExtension and not internal.extension then
