...
ns.Defaults = {
    profile = {
        ...
        Minimap = {
            ...
            addonBarHide = false,
            addonBarButtons = {},
            addonBarAutohide = false,
            addonBarSnap = true,
            addonBarButtonSize = 30,
            addonBarBgColor = { r = 0, g = 0, b = 0, a = 0.6 },
            addonBarHoverColor = { r = 1, g = 1, b = 1, a = 1 },
            showDataTextBar = false,
            dataTextPosition = "INSIDE",
            dataTextTimeFormat = "12H",
            dataTextLeftType = "None",
            dataTextMiddleType = "Time",
            dataTextRightType = "None",
            dataTextLeftFontSize = 12,
            dataTextMiddleFontSize = 12,
            dataTextRightFontSize = 12,
            dataTextLeftX = 0,
            dataTextLeftY = 0,
            dataTextMiddleX = 0,
            dataTextMiddleY = 0,
