...
function UF:CreateAuras(frame)
    ...
    frame.UpdateAuraLayout = function()
        ...
        if ns.AttachmentLogic and ns.AttachmentLogic.ApplyLayout then
            ns.AttachmentLogic:ApplyLayout(unit, "Auras")
        end
    end
...
function UF:UpdateAuras(frame)
    ...
    if frame then
        ...
        frame.RoithiAuras = separateAuras and (buffs or debuffs) or combined
    end
end
...
watcherFrame:RegisterEvent("PLAYER_CONTROL_LOST")
watcherFrame:RegisterEvent("PLAYER_CONTROL_GAINED")
watcherFrame:RegisterEvent("PLAYER_GAINS_VEHICLE_DATA")
watcherFrame:RegisterEvent("PLAYER_LOSES_VEHICLE_DATA")
watcherFrame:RegisterEvent("UPDATE_BONUS_ACTIONBAR")
watcherFrame:RegisterEvent("VEHICLE_UPDATE")
