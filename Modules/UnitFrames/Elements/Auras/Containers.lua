...
local function ConfigureAuraContainer(container, unit, containerSuffix)
    ...
    local parentIsShown = parent and (parent == UIParent or (parent.IsShown and parent:IsShown()) or isDetached)
    ...
    if not hasSavedPos then
        ...
        if isDebuffs and db.separateAuras and db.debuffAnchorToBuffs then
            ...
            if buffContainer and (buffContainer.IsShown and buffContainer:IsShown()) then
